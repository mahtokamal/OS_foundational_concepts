...
|/var/log/mysqld.log or /var/log/mysql.log | - This is the MySQL log file. <br> - All debug, failure and success messages related to the mysqld process and mysqld_safe daemon are logged here. <br> - |
